...
Esta é uma solução para o [desafio de ilustração CSS do aplicativo de bate-papo no Frontend Mentor](https://www.frontendmentor.io/challenges/chat-app-css-illustration-O5auMkFqY). Os desafios do Frontend Mentor ajudam você a melhorar suas habilidades de codificação criando projetos realistas.
...
- **Bônus**: veja a animação da interface de bate-papo no carregamento inicial
