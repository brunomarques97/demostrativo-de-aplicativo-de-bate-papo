...
![Visualização do design para o desafio de codificação de ilustração CSS do aplicativo Chat](./design/desktop-preview.jpg)
...
**Para fazer este desafio, você precisa ter um bom conhecimento de HTML e CSS.**
